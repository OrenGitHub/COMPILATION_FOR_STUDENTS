...
#ifndef YY_AA_PARSER_HH_INCLUDED
# define YY_AA_PARSER_HH_INCLUDED
...
switch (yytype)
    ...
    struct symbol_type : basic_symbol<by_type>
    {
      ...
      {
        YYASSERT (tok == token::TOK_EOF || tok == token::TOK_PLUS || tok == token::TOK_MINUS || tok == token::TOK_TIMES || tok == token::TOK_DIVIDE || tok == token::TOK_LPAREN || tok == token::TOK_RPAREN || tok == 42 || tok == 47);
      }
#else
    ...
    parser (ParsingContext& ctx_yyarg);
    virtual ~parser ();
...
#endif // !YY_AA_PARSER_HH_INCLUDED
